...
inline bool CreateVolatileRegistrySymlink(PCWSTR targetSubkey, PCWSTR linkSubkey)
{
    ...
    return SUCCEEDED(HRESULT_FROM_WIN32(
        ::RegSetValueExW(
            link.get(),
            L"SymbolicLinkValue",
            0,
...
TEST_CASE("BasicRegistryTests::raw_regsam_access", "[registry]")
{
    ...
    SECTION("create/open with a raw REGSAM mask")
    {
        ...
        wil::unique_hkey hkey;
        REQUIRE_SUCCEEDED(
            wil::reg::create_unique_key_nothrow(HKEY_CURRENT_USER, testSubkey, hkey, static_cast<REGSAM>(KEY_QUERY_VALUE | KEY_SET_VALUE)));
        REQUIRE_SUCCEEDED(wil::reg::set_value_dword_nothrow(hkey.get(), dwordValueName, test_dword_two));
...
TEST_CASE("BasicRegistryTests::is_key_volatile", "[registry]")
{
    ...
    SECTION("is_key_volatile_nothrow: non-volatile key")
    {
        wil::unique_hkey hkey;
        DWORD disposition{};
        REQUIRE_SUCCEEDED(HRESULT_FROM_WIN32(
            ::RegCreateKeyExW(
    ...
    SECTION("is_key_volatile_nothrow: volatile key")
    {
        ...
        DWORD disposition{};
        REQUIRE_SUCCEEDED(HRESULT_FROM_WIN32(
            ::RegCreateKeyExW(HKEY_CURRENT_USER, testSubkey, 0, nullptr, REG_OPTION_VOLATILE, KEY_READ, nullptr, hkey.put(), &disposition)));
    ...
    SECTION("is_key_volatile: throwing variant")
    {
        ...
        REQUIRE_SUCCEEDED(HRESULT_FROM_WIN32(
            ::RegCreateKeyExW(parent.get(), L"vol", 0, nullptr, REG_OPTION_VOLATILE, KEY_READ, nullptr, volatileKey.put(), &disposition)));
